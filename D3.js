...
for (let i = 0; i < femaleCharacters.length; i++) {
  let nome = femaleCharacters[i].name;
  let index = characters.indexOf(nome);
...
console.log("personaggio a caso di star wars");
console.log("nome:", valore.name);
console.log("anno di nascita:", valore.birth_year);
console.log("genere:", valore.gender);
console.log("colore degli occhi:", valore.eye_color);
console.log("altezza:", valore.height);
console.log("peso:", valore.mass);
console.log("colore capelli:", valore.hair_color);
console.log("colore della pelle:", valore.skin_color);
